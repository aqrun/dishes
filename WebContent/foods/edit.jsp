...
<div class="container-fluid">
	<div class="row">
		...
		<div
			...
			<h1 class="h2">Update food</h1>
		</div>

		<% 
		Integer id1 = Integer.parseInt(request.getParameter("id"));
		Food food = FoodModel.findFoodById(this.getServletContext(),id1);
						...
						<div class="col-sm-10">
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input ipt_favor" type="radio"
									...
									<%if(food.getFavor() == f.getId()){ %>checked<%} %>
						...
						<div class="col-sm-10">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control ipt_thumb"
									name="thumb" value="<%=food.getThumb()%>">
							</div>
							<div class="col-sm-4">
								<div class="file_upload_w">
									<div class="row">
										...
										<div class="col-sm-4">
											<img 
												<%if(!food.getThumb().equals("")){ %>
												src="<%=basePath + food.getThumb() %>"
												<%} %> 
												class="img_preview" 
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control ipt_price"
								name="price" value="<%=food.getPrice()%>">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">描述</label>
						<div class="col-sm-10">
							<textarea class="form-control ipt_desc" rows="3" 
								name="description"><%=food.getDescription() %></textarea>
						</div>
					</div>
					<div class="form-group row">
